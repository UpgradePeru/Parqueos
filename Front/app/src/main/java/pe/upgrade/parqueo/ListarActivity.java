...
import pe.upgrade.parqueo.model.BuscarAdaptadorParqueo;
...
public class ListarActivity extends AppCompatActivity {
    ...
    BuscarAdaptadorParqueo adaptador;
    ...
    private void mostrar() {
        adaptador = new BuscarAdaptadorParqueo(this, application, canchas, fecha);
    ...
    public boolean onPrepareOptionsMenu(Menu menu)
    {
        ...
        final Model model = Model.getInstance(ListarActivity.this.getApplication());

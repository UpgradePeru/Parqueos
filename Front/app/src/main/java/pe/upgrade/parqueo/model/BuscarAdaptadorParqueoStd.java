...
public class BuscarAdaptadorParqueoStd extends RecyclerView.Adapter<BuscarAdaptadorParqueoStd.MyViewHolder> {
    private Context context;
    private Application application;
    private List<Cancha> listaCanchas = new ArrayList<Cancha>();
    private String fechatxt;

    public BuscarAdaptadorParqueoStd(Context context, Application application, List<Cancha> listaCanchas, String fechatxt) {
    ...
    @NonNull
    @Override
    public BuscarAdaptadorParqueoStd.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.buscar_fila_parqueo_std, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BuscarAdaptadorParqueoStd.MyViewHolder holder, int position) {
